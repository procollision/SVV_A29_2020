...
def get_geom(r,cl,ts,tb,dt,s_space,CG_z):
    ...
    z2_bounds.append([0,np.pi/2])
    z2.append(lambda theta: r*r*np.cos(theta)-CG_z)
    z2_thickness.append(ts)
    z2_stringer.append(1)
    z2_dt_list.append(dt/r)
    z2_offset.append(s_space/r)
    z2_stringer_index.append(range(0,3))

    z2_bounds.append([0,slen])
    z2.append(lambda s: -s*(cl-r)/slen-CG_z)
    z2_thickness.append(ts)
    z2_stringer.append(1)
